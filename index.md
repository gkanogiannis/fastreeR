...
![Project
Icon](https://raw.githubusercontent.com/gkanogiannis/fastreeR/master/icon.png)
...
accept the same windowing parameters (`windowBp`, `windowVariants`,
`windowStep`, `windowMinVariants`, plus `longFormat` for `vcf2dist`).
When any window parameter is set the return value changes to one of:
...
See the [LICENSE](https://gkanogiannis.github.io/fastreeR/LICENSE.md)
file for details.
